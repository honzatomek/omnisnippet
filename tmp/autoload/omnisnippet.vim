...
function! omnisnippet#Read(mode)
  if !isdirectory(s:omnisnippet_snippets_location)
...
function! omnisnippet#Write(mode) range
"   echom 'Mode: ' . a:mode
...
function! omnisnippet#OmniSnippet_RestoreDefaults()
...
function! omnisnippet#OmniSnippet_MapEsc()
  if !pumvisible()
    return "\<ESC>"
  else
